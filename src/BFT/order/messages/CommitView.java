// $Id: CommitView.java 722 2011-07-04 09:24:35Z aclement $
 ...
 **/
public class CommitView extends MacArrayMessage {


    public CommitView(Parameters param, long view, long seq,
                      HistoryDigest hist, int sendingReplica) {
        super(param, MessageTags.CommitView, computeSize(param, hist), sendingReplica,
                param.getOrderCount());
        viewNo = view;
        seqNo = seq;
        history = hist;
    ...
    public CommitView(byte[] bits, Parameters param) {
        super(bits, param);
        if (getTag() != MessageTags.CommitView) {
    ...
    public boolean equals(CommitView nb) {
        return matches(nb) && super.equals(nb);
    }

    /**
     * computes the size of the bits specific to CommitView
     **/
    ...
    public static void main(String args[]) {
        ...
        CommitView vmb = new CommitView(param, 123, 534, hist, 1);
        //System.out.println("initial: "+vmb.toString());
        UnsignedTypes.printBytes(vmb.getBytes());
        CommitView vmb2 = new CommitView(vmb.getBytes(), param);
        //System.out.println("\nsecondary: "+vmb2.toString());
        UnsignedTypes.printBytes(vmb2.getBytes());

        vmb = new CommitView(param, 42, 123, hist, 2);
        //System.out.println("\ninitial: "+vmb.toString());
        UnsignedTypes.printBytes(vmb.getBytes());
        vmb2 = new CommitView(vmb.getBytes(), param);
        //System.out.println("\nsecondary: "+vmb2.toString());
        UnsignedTypes.printBytes(vmb2.getBytes());
