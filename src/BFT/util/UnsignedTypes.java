// $Id: UnsignedTypes.java 722 2011-07-04 09:24:35Z aclement $
 ...
 * and java types.
 * <p>
 * Maps unsigned 16 bit integers to int, unsigned 32 bit integers to long, and unsigned 64 bits to long.
 * <p>
...
public class UnsignedTypes {
    ...
    // the following translate the unsigned c sizes into java objects required for the similar encoding
    ...
    public static void main(String args[]) {
        ...
        long j = 2;
        for (; ((int) j) > 0; j = (j - 1) * 2 + 1)
            System.out.println(j + " : " + bytesToString(longToBytes(j)) + " : " + bytesToLong(longToBytes(j)));

        System.out.println("testing  int");
        int k = 2;
        for (; ((short) k) > 0; k = (k - 1) * 2 + 1)
            System.out.println(k + " : " + bytesToString(intToBytes(k)) + " : " + bytesToInt(intToBytes(k)));
