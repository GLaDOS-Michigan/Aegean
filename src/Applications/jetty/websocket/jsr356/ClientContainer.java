...
import Applications.jetty.websocket.jsr356.annotations.AnnotatedEndpointScanner;
import Applications.jetty.websocket.jsr356.client.AnnotatedClientEndpointMetadata;
import Applications.jetty.websocket.jsr356.client.EmptyClientEndpointConfig;
import Applications.jetty.websocket.jsr356.client.SimpleEndpointMetadata;
import Applications.jetty.websocket.jsr356.decoders.PrimitiveDecoderMetadataSet;
import Applications.jetty.websocket.jsr356.encoders.PrimitiveEncoderMetadataSet;
import Applications.jetty.websocket.jsr356.endpoints.EndpointInstance;
import Applications.jetty.websocket.jsr356.endpoints.JsrEventDriverFactory;
...
public class ClientContainer extends ContainerLifeCycle implements WebSocketContainer {
    ...
    private Session connect(EndpointInstance instance, URI path) throws IOException {
        ...
        Future<Applications.jetty.websocket.api.Session> futSess = client.connect(instance, path, req, upgradeListener);
        try {
