...
package Applications.jetty.websocket.api.extensions;
...
public interface OutgoingFrames {
     ...
     *
     * @param frame    the frame to eventually write to the network.
     * @param callback the optional callback to use for success/failure of the network write operation. Can be null.
     */
