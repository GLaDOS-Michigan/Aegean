...
public class ServletContextHandler extends ContextHandler {
    ...
    protected Class<? extends SecurityHandler> _defaultSecurityHandlerClass = Applications.jetty.security.ConstraintSecurityHandler.class;
    ...
    public class Context extends ContextHandler.Context {
        ...
        public RequestDispatcher getNamedDispatcher(String name) {
            ContextHandler context = Applications.jetty.servlet.ServletContextHandler.this;
            if (_servletHandler == null)
                return null;
