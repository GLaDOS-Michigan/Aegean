...
import Applications.jetty.io.SelectChannelEndPoint;
...
public abstract class AbstractHttpClientTransport extends ContainerLifeCycle implements HttpClientTransport {
    ...
    protected class ClientSelectorManager extends SelectorManager {
        ...
        @Override
        public Applications.jetty.io.Connection newConnection(SocketChannel channel, EndPoint endPoint, Object attachment) throws IOException {
            @SuppressWarnings("unchecked")
