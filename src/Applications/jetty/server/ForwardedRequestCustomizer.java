...
import Applications.jetty.server.HttpConfiguration.Customizer;
...
public class ForwardedRequestCustomizer implements Customizer {
    ...
    /**
     * @param forwardedCipherSuite The header name holding a forwarded cipher suite (default null)
     */
    ...
    /**
     * @param forwardedSslSessionId The header name holding a forwarded SSL Session ID (default null)
     */
