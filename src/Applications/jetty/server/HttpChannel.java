...
public class HttpChannel<T> implements HttpParser.RequestHandler<T>, Runnable {
    ...
    public boolean handle() {
        ...
        loop:
        while (action.ordinal() < HttpChannelState.Action.WAIT.ordinal() && getServer().isRunning()) {
            boolean error = false;
            try {
