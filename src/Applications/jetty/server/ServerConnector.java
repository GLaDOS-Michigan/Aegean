...
import Applications.jetty.io.SelectorManager.ManagedSelector;
...
public class ServerConnector extends AbstractNetworkConnector {
     ...
     * @param selectors the number of selector threads, or -1 for a default value. Selectors notice and schedule established connection that can make IO progress.
     */
    public ServerConnector(
            @Name("server") Server server,
