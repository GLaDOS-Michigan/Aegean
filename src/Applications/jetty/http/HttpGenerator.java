...
import Applications.jetty.http.HttpTokens.EndOfContent;
...
public class HttpGenerator {
    ...
    public final static ResponseInfo RESPONSE_500_INFO =
            new ResponseInfo(HttpVersion.HTTP_1_1, new HttpFields() {{
                put(HttpHeader.CONNECTION, HttpHeaderValue.CLOSE);
            }}, 0, HttpStatus.INTERNAL_SERVER_ERROR_500, null, false);
