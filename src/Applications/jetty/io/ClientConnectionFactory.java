...
public interface ClientConnectionFactory {
    /**
     * @param endPoint the {@link Applications.jetty.io.EndPoint} to link the newly created connection to
    ...
    public static class Helper {
         ...
         * <p/>
         * The {@code oldConnection} will be closed by invoking {@link Applications.jetty.io.Connection#onClose()}
         * and the {@code newConnection} will be opened by invoking {@link Applications.jetty.io.Connection#onOpen()}.
         *
