...
import Applications.jetty.security.authentication.LoginAuthenticator;
import Applications.jetty.security.authentication.SessionAuthentication;
...
public class JaspiAuthenticator extends LoginAuthenticator {
    ...
    /**
     * @see Applications.jetty.security.authentication.LoginAuthenticator#login(java.lang.String, java.lang.Object, javax.servlet.ServletRequest)
     */
    @Override
