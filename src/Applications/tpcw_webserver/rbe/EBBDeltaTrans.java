/*------------------------------------------------------------------------
 * rbe.EBBDeltaTrans.java
 * Timothy Heil
 * 10/26/99
 *
 * ECE902 Fall '99
 *
 * TPC-B Dummy Delta transition.
 *------------------------------------------------------------------------
 *
...
public class EBBDeltaTrans extends EBTransition {

    public static final String miscStuff =
