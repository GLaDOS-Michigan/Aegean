...
public class EBWWWFactory extends EBFactory {
    private static final EBTransition www =
            new EBWWWTrans();
    ...
    public EB getEB(RBE rbe, String membershipfile) {
        EB res = (new EB(rbe, transProb, transArray, -1,
                "WWW EB #" + (count), membershipfile, count, 0));//!!!Previously "EB + " + count was being used instead of membership file
        count++;
        return res;
    }
