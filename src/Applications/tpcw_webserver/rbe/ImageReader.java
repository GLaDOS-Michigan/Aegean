...
public class ImageReader {
    ...
    private EBClientProxyInterface proxy;

    public ImageReader(RBE rbe, EBClientProxyInterface proxy, URL srcURL, String url, byte[] buffer) {
        imgURLStr = url;
        this.buffer = buffer;
        imgURL = null;
        this.srcURL = srcURL;
