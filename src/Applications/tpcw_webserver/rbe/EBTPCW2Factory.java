 ...
 * 10/20/99
 * 
 * Produces TPCW EBs for transistion subset 2 (The Shopping Mix - WIPS).
 *------------------------------------------------------------------------
 *
...
public class EBTPCW2Factory extends EBFactory {
    ...
    public EB getEB(RBE rbe, String membershipFile) {
        EB res = (new EB(rbe, cTransProb, cTransArray, 1000000,
                "TPCW Shopping Mix EB #" + (count), membershipFile, count, 0));
        count++;
        return res;
    }
