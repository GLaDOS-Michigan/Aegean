...
public class Cart implements Serializable {
    ...
    public Cart(ResultSet rs, double C_DISCOUNT) throws java.sql.SQLException {
        ...
        while (rs.next()) {// While there are lines remaining
            CartLine line = new CartLine(rs.getString("i_title"), rs
                    .getDouble("i_cost"), rs.getDouble("i_srp"), rs
                    .getString("i_backing"), rs.getInt("scl_qty"), rs
                    .getInt("scl_i_id"));
    ...
    public String toString() {
        ...
        sb.append("Cart with " + lines.size() + " lines\n");
