...
public class TPCW_User {
    public final static boolean TRACE = false;
    public final static boolean TRACE_ROLLBACK = true;
    Random r;
    ...
    public TPCW_User(int id, int nbTPCWs) {
        this.id = id;
    ...
    private void doGetBooksByTitle(Connection con) throws Exception {
        ...
        while (nbRetry > 0) {
            try {
                booksByTitle = TPCW_Database.doTitleSearch(title, con);
            } catch (SQLException e) {
    ...
    private void doGetCustomer(Connection con) throws Exception {
        ...
        // 10%
        if (p < 50) {
            state = State.GET_MOST_RECENT_ORDER;
        }
        //else
        //{
        state = State.DO_BUY_CONFIRM;
        //}
    }
