...
public class TPCW_promotional_processing {
    ...
    public static void DisplayPromotions(PrintWriter out,
                                         ...
                                         int new_sid) {
        int I_ID = TPCW_Util.getRandomI_ID(TPCW_Util.getRandomer(res));
        MTCollectionWrapper<Integer> related_item_ids = new MTCollectionWrapper<Integer>(
                new Vector<Integer>(), true, true);
        MTCollectionWrapper<String> thumbnails = new MTCollectionWrapper<String>(
