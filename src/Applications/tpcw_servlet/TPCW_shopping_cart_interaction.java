...
public class TPCW_shopping_cart_interaction extends TPCW_servlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (cart != null) for (i = 0; i < cart.lines.size(); i++) {
        ...
        if (cart != null) out.print("</TABLE><B><I>Subtotal price: " + cart.SC_SUB_TOTAL +
                "</I></B>\n");
