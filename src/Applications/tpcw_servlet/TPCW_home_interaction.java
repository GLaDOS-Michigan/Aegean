...
public class TPCW_home_interaction extends TPCW_servlet {
      ...
      */
      ...
      /*SERVLET SETUP*/
        ...
        for (i = 0; i < column1.size(); i++) {
            ...
            if (C_ID != null)
                url = url + "&C_ID=" + C_ID;
//   System.err.println("############## Before encoding: "+ url);
            String temp = res.encodeURL(url);
//   System.err.println("############## After encoding: " + temp);
            out.print("<A HREF=\"" + temp);
