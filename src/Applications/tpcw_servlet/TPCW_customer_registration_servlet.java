...
public class TPCW_customer_registration_servlet extends TPCW_servlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (C_ID != null) {
            ...
            TPCW_Database.GetUserName(c_idnum);
        } else {
        }
        ...
        out.print("<FORM ACTION=\"TPCW_buy_request_servlet;$sessionid$" +
