...
public class TPCW_buy_request_servlet extends TPCW_servlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (RETURNING_FLAG.equals("Y")) {
            ...
            if (cust == null) {
                System.err.println("WARN: cust is null");
                out.close();
                return;
            }
        ...
        out.print("<HR><FORM ACTION=\"TPCW_buy_confirm_servlet;$sessionid$" +
