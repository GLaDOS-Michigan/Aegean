...
public class TPCW_order_display_servlet extends TPCW_servlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (uname != null && passwd != null) {
            ...
            if (!storedpasswd.equals(passwd)) {
                ...
                MTCollectionWrapper<OrderLine> lines = new MTCollectionWrapper<OrderLine>(
                        new Vector<OrderLine>(), true, true);
    ...
    private void printOrder(Order order, MTCollectionWrapper<OrderLine> lines, PrintWriter out) {
        int i;
