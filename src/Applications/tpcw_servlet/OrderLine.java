...
public class OrderLine implements Externalizable {
    private static final long serialVersionUID = 6014187577530033115L;
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeInt(ol_i_id);
        out.writeUTF(i_title);
        out.writeUTF(i_publisher);
        out.writeDouble(i_cost);
        out.writeInt(ol_qty);
        out.writeDouble(ol_discount);
        out.writeUTF(ol_comments);
    }
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        this.ol_i_id = in.readInt();
        this.i_title = in.readUTF();
        this.i_publisher = in.readUTF();
        this.i_cost = in.readDouble();
        this.ol_qty = in.readInt();
        this.ol_discount = in.readDouble();
        this.ol_comments = in.readUTF();
    }
}
