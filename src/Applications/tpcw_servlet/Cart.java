...
public class Cart implements Externalizable {
    ...
    private static final long serialVersionUID = -8228918737444123207L;
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        out.writeDouble(SC_SUB_TOTAL);
        out.writeDouble(SC_TAX);
        out.writeDouble(SC_SHIP_COST);
        out.writeDouble(SC_TOTAL);
        ...
        for (int i = 0; i < len; i++) {
            out.writeObject(lines.elementAt(i));
        }
    }
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        this.SC_SUB_TOTAL = in.readDouble();
        this.SC_TAX = in.readDouble();
        this.SC_SHIP_COST = in.readDouble();
        this.SC_TOTAL = in.readDouble();

        int len = in.readInt();

        this.lines = new Vector<CartLine>();

        for (int i = 0; i < len; i++) {
            this.lines.add((CartLine) in.readObject());
        }
    }
