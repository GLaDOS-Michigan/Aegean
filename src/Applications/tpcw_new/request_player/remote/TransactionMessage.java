...
public class TransactionMessage implements Externalizable {
    ...
    public void readExternal(ObjectInput arg0) throws IOException,
        ...
        this.requestsStatementCodes = new int[nbElem];
        this.requestsArguments = new String[nbElem];
        this.requestsShoppingIDs = new int[nbElem];
    ...
    public void writeExternal(ObjectOutput arg0) throws IOException {
        ...
        for (int i = 0; i < requestsStatementCodes.length; i++) {
            arg0.writeInt(this.requestsStatementCodes[i]);
            arg0.writeUTF(this.requestsArguments[i]);
            arg0.writeInt(this.requestsShoppingIDs[i]);
        }
    }
}
