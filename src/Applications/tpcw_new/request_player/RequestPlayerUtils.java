...
public class RequestPlayerUtils {
    ...
    public enum methodName {
        ...
        /* WRITE */
        adminUpdate, refreshSession, createNewCustomer, doBuyConfirm, createEmptyCart, doCart, getCart, commit,
        /* UNKNOWN */
        unknown
    }
    ...
    public static void initProperties(String f) {
        ...
        System.err.println("### request pattern is: " + requestPatternVersion);
