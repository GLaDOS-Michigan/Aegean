...
/**
 * The main controller class of the benchmark application. To run the benchmark,
 * call the main method of this class.
 */
public class TestPerformance {
    ...
    private void openResults() throws SQLException {
        ...
        try {
            ...
            stat
                    .execute("CREATE TABLE IF NOT EXISTS RESULTS(TESTID INT, TEST VARCHAR, "
    ...
    private void testAll(ArrayList<Database> dbs, ArrayList<Bench> tests,
        ...
        for (int i = 0; i < dbs.size(); i++) {
            ...
            int statPerSec = db.getExecutedStatements() * 1000
                    / db.getTotalTime();
    ...
    private void runDatabase(Database db, ArrayList<Bench> tests, int size)
            throws Exception {
