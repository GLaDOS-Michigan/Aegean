...
public class TableLink extends Table {
    ...
    private final ObjectArray<Index> indexes = ObjectArray.newInstance(false);
    ...
    private void readMetaData() throws SQLException {
        ...
        int i = 0;
        ObjectArray<Column> columnList = ObjectArray.newInstance(false);
        ...
        if (rs != null && rs.next()) {
            ...
            list = ObjectArray.newInstance(false);
            do {
