...
public class Column {
    ...
    public int hashCode() {
        // TODO I commented the code of hashCode for MerkleTree
    ...
    public Value convert(Value v) throws SQLException {
        try {
            ...
            if (e.getErrorCode() == ErrorCode.DATA_CONVERSION_ERROR_1) {
                e = Message.getSQLException(ErrorCode.DATA_CONVERSION_ERROR_1,
                        v.getSQL() + " (" + getCreateSQL() + ")");
            }
            throw e;
        }
    }
        ...
        if (checkConstraint != null) {
            ...
            if (Boolean.FALSE.equals(v.getBoolean())) {
                throw Message.getSQLException(
                        ErrorCode.CHECK_CONSTRAINT_VIOLATED_1, checkConstraint
                                .getSQL());
            }
        }
     ...
     * @param temporary true if the sequence is temporary and does not need to be
     *                  stored
     */
    ...
    public String getCreateSQL() {
        ...
        if (originalSQL != null) {
            ...
            switch (type) {
                case Value.DECIMAL:
                    buff.append('(').append(precision).append(", ").append(
                            scale).append(')');
                    break;
                case Value.BYTES:
                case Value.STRING:
