...
public class LogSystem {
    ...
    public boolean recover() throws SQLException {
        ...
        synchronized (database) {
            ...
            undo = ObjectArray.newInstance(false);
            for (int i = 0; i < activeLogs.size(); i++) {
            ...
            inDoubtTransactions = ObjectArray.newInstance(false);
    ...
    public void open() throws SQLException {
        ...
        activeLogs = ObjectArray.newInstance(false);
    ...
    public ObjectArray<LogFile> getActiveLogFiles() {
        synchronized (database) {
            ObjectArray<LogFile> list = ObjectArray.newInstance(false);
