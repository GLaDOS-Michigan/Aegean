...
public class SysProperties {
     ...
     * cacheSizeIndexShift.
     */
    public static final String CACHE_TYPE_DEFAULT = getStringSetting(
            "h2.cacheTypeDefault", "LRU");
     ...
     */
    public static final String DEFAULT_ESCAPE = getStringSetting(
            "h2.defaultEscape", "\\");
     ...
     * </p>
     */
    public static final int DEFAULT_MAX_LENGTH_INPLACE_LOB = getIntSetting(
            "h2.defaultMaxLengthInplaceLob", Constants.VERSION <= 1.1 ? 1024
                    : 4096);
     ...
     */
    public static final int DEFAULT_RESULT_SET_CONCURRENCY = getIntSetting(
            "h2.defaultResultSetConcurrency", ResultSet.CONCUR_READ_ONLY);
     ...
     * logins will double the time until DELAY_WRONG_PASSWORD_MAX. To disable
     * the delay, set this system property to 0.
     */
     ...
     * to uppercase.
     */
    public static final boolean IDENTIFIERS_TO_UPPER = getBooleanSetting(
            "h2.identifiersToUpper", true);
    ...
    /**
     * System property <code>h2.maxCompactCount</code> (default:
     * Integer.MAX_VALUE).<br />
     * The maximum number of pages to move when closing a database.
     */
    public static final int MAX_COMPACT_COUNT = getIntSetting(
            "h2.maxCompactCount", Integer.MAX_VALUE);

    /**
     * System property <code>h2.maxCompactTime</code> (default: 1000).<br />
     * The maximum time in milliseconds used to compact a database when closing.
     */
    public static final int MAX_COMPACT_TIME = getIntSetting(
            "h2.maxCompactTime", 1000);
     ...
     */
    public static final int MAX_FILE_RETRY = Math.max(1, getIntSetting(
            "h2.maxFileRetry", 16));
     ...
     * </p>
     */
    public static final boolean NULL_CONCAT_IS_NULL = getBooleanSetting(
            "h2.nullConcatIsNull", Constants.VERSION >= 1.2);

    /**
     * System property <code>h2.objectCache</code> (default: true).<br />
     * Cache commonly used objects (integers, strings).
     */
    public static final boolean OBJECT_CACHE = false;
    // TODO removed cache for Merkle Trees
    // public static final boolean OBJECT_CACHE =
    // getBooleanSetting("h2.objectCache", true);
     ...
     * </p>
     */
    public static final boolean OPTIMIZE_IN_LIST = getBooleanSetting(
            "h2.optimizeInList", Constants.VERSION >= 1.2);
     ...
     */
    public static final boolean OPTIMIZE_OR = getBooleanSetting(
            "h2.optimizeOr", false);
     ...
     * </p>
     */
    public static final boolean PAGE_STORE = getBooleanSetting(H2_PAGE_STORE,
            Constants.VERSION >= 1.2);

    /**
     * System property <code>h2.pageStoreTrim</code> (default: true).<br />
     * Trim the database size when closing.
     */
    public static final boolean PAGE_STORE_TRIM = getBooleanSetting(
            "h2.pageStoreTrim", true);

    /**
     * System property <code>h2.pageStoreInternalCount</code> (default:
     * false).<br />
     * Update the row counts on a node level.
     */
    public static final boolean PAGE_STORE_INTERNAL_COUNT = getBooleanSetting(
            "h2.pageStoreInternalCount", false);
     ...
     * sends his encoding.
     */
    public static final String PG_DEFAULT_CLIENT_ENCODING = getStringSetting(
            "h2.pgClientEncoding", "UTF-8");
     ...
     */
    public static final boolean REUSE_SPACE_BTREE_INDEX = getBooleanSetting(
            "h2.reuseSpaceBtreeIndex", true);
    ...
    /**
     * System property <code>h2.serverResultSetFetchSize</code> (default:
     * 100).<br />
     ...
     * The H2 Console will abbreviate (truncate) result values larger than this
     * size.
     */
    ...
    /**
     * INTERNAL. System property <code>h2.scriptDirectory</code> (default:
     * empty string).<br />
