...
public class JdbcConnection extends TraceObject implements Connection {
     ...
     */
    protected transient Exception openStackTrace;
    ...
    private transient CommandInterface commit, rollback;
    private transient CommandInterface setAutoCommitTrue, setAutoCommitFalse,
            getAutoCommit;
    private transient CommandInterface getReadOnly, getGeneratedKeys;
    private transient CommandInterface setLockMode, getLockMode;
    private transient CommandInterface setQueryTimeout, getQueryTimeout;
    ...
    private transient Statement executingStatement;
    ...
    public JdbcConnection(ConnectionInfo ci, boolean useBaseDir)
        ...
        try {
            ...
            // MerkleTreeInstance.add(this); called in the constructor of
            // Session
            trace = session.getTrace();
            // MerkleTreeInstance.add(trace);
            ...
            System.err.println("############!!!!!!!~~~~~~~~ Current URL of this Connection is: " + this.url);
            // MerkleTreeInstance.add(openStackTrace);
    ...
    public Statement createStatement() throws SQLException {
        try {
            ...
            return new JdbcStatement(this, id, ResultSet.TYPE_FORWARD_ONLY,
                    SysProperties.DEFAULT_RESULT_SET_CONCURRENCY, false);
        } catch (Exception e) {
            throw logAndConvert(e);
        }
    }
     ...
     * @throws SQLException if the connection is closed or the result set type or
    ...
    PreparedStatement prepareAutoCloseStatement(String sql) throws SQLException {
        try {
            ...
            return new JdbcPreparedStatement(this, sql, id,
                    ResultSet.TYPE_FORWARD_ONLY,
                    SysProperties.DEFAULT_RESULT_SET_CONCURRENCY, true);
        } catch (Exception e) {
            throw logAndConvert(e);
        }
    }
                ...
                synchronized (session) {
                    if (!session.isClosed()) {
                        try {
                            ...
                            // (the transaction can't be rolled back after
                            // re-connecting)
     ...
     * @throws SQLException if the connection is closed or the isolation level is not
     *                      supported
     */
    ...
    public void setQueryTimeout(int seconds) throws SQLException {
        try {
            ...
            setQueryTimeout = prepareCommand("SET QUERY_TIMEOUT ?",
                    setQueryTimeout);
            setQueryTimeout.getParameters().get(0).setValue(
                    ValueInt.get(seconds * 1000), false);
    ...
    public int getQueryTimeout() throws SQLException {
        try {
            ...
            getQueryTimeout = prepareCommand(
                    ...
                    getQueryTimeout);
            getQueryTimeout.getParameters().get(0).setValue(
                    ValueString.get("QUERY_TIMEOUT"), false);
     ...
     * @throws SQLException if the connection is closed or the holdability is not
     *                      supported
     */
    ...
    public Savepoint setSavepoint() throws SQLException {
        try {
            ...
            checkClosed();
            CommandInterface set = prepareCommand("SAVEPOINT "
                            + JdbcSavepoint.getName(null, savepointId),
                    Integer.MAX_VALUE);
            set.executeUpdate();
    ...
    public Savepoint setSavepoint(String name) throws SQLException {
        try {
            ...
            checkClosed();
            CommandInterface set = prepareCommand("SAVEPOINT "
                    + JdbcSavepoint.getName(name, 0), Integer.MAX_VALUE);
            set.executeUpdate();
    ...
    private void checkTypeConcurrency(int resultSetType,
                                      int resultSetConcurrency) throws SQLException {
        switch (resultSetType) {
            ...
            case ResultSet.TYPE_SCROLL_SENSITIVE:
                break;
            default:
                throw Message.getInvalidValueException("" + resultSetType,
                        "resultSetType");
        }
    ...
    public void setExecutingStatement(Statement stat) {
        // TODO: MT commented to avoid updates in SELECT statements
    ...
    ResultSet getGeneratedKeys(JdbcStatement stat, int id) throws SQLException {
        getGeneratedKeys = prepareCommand("CALL SCOPE_IDENTITY()",
                getGeneratedKeys);
        ResultInterface result = getGeneratedKeys.executeQuery(0, false);
        ResultSet rs = new JdbcResultSet(this, stat, result, id, false, true,
                false);
        return rs;
    }
    ...
    public Blob createBlob() throws SQLException {
        try {
            ...
            checkClosedForWrite();
            try {
                ValueLob v = ValueLob.createSmallLob(Value.BLOB,
                        MemoryUtils.EMPTY_BYTES);
     ...
     *
     * @param x      the reader
     * @param length the length (if smaller or equal than 0, all data until the end
     *               of file is read)
     * @return the value
     */
