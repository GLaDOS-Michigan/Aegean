...
public class Select extends Query {
    ...
    private ObjectArray<TableFilter> filters = ObjectArray.newInstance(false);
    private ObjectArray<TableFilter> topFilters = ObjectArray.newInstance(false);
    ...
    private Index getSortIndex() throws SQLException {
        ...
        ObjectArray<Column> sortColumns = ObjectArray.newInstance(false);
    ...
    public void init() throws SQLException {
        ...
        if (orderList != null || group != null) {
            expressionSQL = ObjectArray.newInstance(false);
