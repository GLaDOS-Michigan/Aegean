 ...
 */
public class ValueDouble extends Value implements merkle.MerkleTreeObject, merkle.MerkleTreeCloneable {
    ...
    public void copyObject(Object dst) {
        ValueDouble target = (ValueDouble) dst;
        target.value = this.value;
    }

    public Object cloneObject() {
        ValueDouble target = new ValueDouble();
