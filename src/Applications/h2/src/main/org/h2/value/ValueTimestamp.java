 ...
 */
public class ValueTimestamp extends Value implements merkle.MerkleTreeObject, merkle.MerkleTreeCloneable {
    ...
    public void copyObject(Object dst) {
        ValueTimestamp target = (ValueTimestamp) dst;
        target.value = this.value;
    }

    @Override
    public Object cloneObject() {
        ValueTimestamp target = new ValueTimestamp();
