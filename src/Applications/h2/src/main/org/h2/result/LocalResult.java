...
public class LocalResult implements ResultInterface {
    ...
    public LocalResult(Session session, Expression[] expressions,
        ...
        rows = ObjectArray.newInstance(false);
     ...
     * @param visibleColumnCount the number of visible columns
     */
    public LocalResult(Session session, ObjectArray<Expression> expressionList,
                       int visibleColumnCount) {
    ...
    private static ObjectArray<Expression> getExpressionColumns(
            Session session, ResultSet rs) throws SQLException {
        ResultSetMetaData meta = rs.getMetaData();
        int columnCount = meta.getColumnCount();
        ObjectArray<Expression> cols = ObjectArray.newInstance(false,
                columnCount);
