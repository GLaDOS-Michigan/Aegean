    ...
    public void run() {
        try {
            ...
            try {
                ...
                MerkleTreeInstance.add(originalURL);
                ...
                String s = transfer.readString();
                MerkleTreeInstance.add(s);
                ci.setUserName(s);

                byte[] b = transfer.readBytes();
                MerkleTreeInstance.add(b);
                ci.setUserPasswordHash(b);

                b = transfer.readBytes();
                MerkleTreeInstance.add(b);
                ci.setFilePasswordHash(b);
