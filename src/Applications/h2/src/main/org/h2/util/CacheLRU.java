...
public class CacheLRU implements Cache {
    ...
    private void removeOld() throws SQLException {
        int i = 0;
        ObjectArray<CacheObject> changed = ObjectArray.newInstance(false);
        int mem = sizeMemory;
        int rc = recordCount;
...
//            testConsistency();
//        }
        ObjectArray<CacheObject> list = ObjectArray.newInstance(false);
...
//        ObjectArray list = ObjectArray.newInstance(false);
//        while(it.hasNext()) {
