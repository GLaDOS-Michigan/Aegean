/*------------------------------------------------------------------------
 * rbe.EBWSearchReqTrans.java
 * Timothy Heil
 * 10/13/99
 *
 * ECE902 Fall '99
 *
 * TPC-W search request transition.  Supplies the URL for the page.
 *------------------------------------------------------------------------
 *
...
public class SearchReqTrans extends Transition {

    @Override
    public void execute(User eb, Connection con, Statement stat) throws SQLException {
        System.out.println("Executing EBWSearchReqTrans");
        // Display promotions
