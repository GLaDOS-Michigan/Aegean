/*------------------------------------------------------------------------
 * rbe.EBWNewProdTrans.java
 * Timothy Heil
 * 11/10/99
 *
 * ECE902 Fall '99
 *
 * TPC-W New-products transition from the home page to the new products
...
public class NewProdTrans extends Transition {
    public void execute(User eb, Connection con, Statement stat)
            throws SQLException {
        if (Benchmark.TRACE) {
            System.out.println("Executing NewProdTrans");
        }
        ...
        eb.books = TPCW_Database.getNewProducts(subject, con, 0);
