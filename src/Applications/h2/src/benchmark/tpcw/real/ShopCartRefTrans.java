...
public class ShopCartRefTrans extends Transition {
    /* protected String url; inherited. */

    @Override
    public void execute(User eb, Connection con, Statement stat) throws SQLException {
        System.out.println("Executing ShopCartRefTrans");
        // c needs to be initialized to the number of books from the previous
        // page
        int c = 10;
	 ...
	 * transistion, since we are coming from the shopping cart page. But, why
	 * not be redundant...
	 */
}
