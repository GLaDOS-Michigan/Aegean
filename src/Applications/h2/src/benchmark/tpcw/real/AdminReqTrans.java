...
public class AdminReqTrans extends Transition {

    @Override
    public void execute(User eb, Connection con, Statement stat) throws SQLException {
        System.out.println("Executing EBWAdminReqTrans");
        // Retrieve I_ID from the eb
        int I_ID = -1;

        //Book book = TPCW_Database.getBook(I_ID, null, 0);
    }
}
