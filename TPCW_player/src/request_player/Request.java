...
public class Request
{
	...
	private long execTime; // execution time of the request, in µs
	 ...
	 * 
	 * @param req
	 *            the string from which the Request is created
	 */
	...
	public String toString()
	{
		...
		result = "date: " + date + ", exec time: " + execTime + "µs, called method: " + calledMethod
